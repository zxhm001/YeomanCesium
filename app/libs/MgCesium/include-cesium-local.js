    ...
    function load() {
        ...
        if (!inArray(excludes, 'cesium')) {
            if (inArray(includes, 'cesium-1.59')) {
                ...
                inputCSS(httpUrl + '/cesium-old/Widgets/widgets.css');
                // inputCSS(httpUrl + '/cesium-old/MapGIS/css/mapgis.css');
                inputScript(httpUrl + '/cesium-old/Cesium.js');
            } else {
        ...
        if (!inArray(excludes, 'plugin')) {
            inputScript(httpUrl + '/zondyclient/webclient-cesium-plugin.min.js');
        }
